...
test_that("calculateGroupCentroid", {
    centroids = calculateGroupCentroid(ct2, group_VARS = c("peak_MCF10A_CTCF", "peak_MCF10AT1_CTCF"))
    expect_setequal(rownames(centroids), c("FALSE,TRUE", "TRUE,FALSE", "TRUE,TRUE", "FALSE,FALSE"))
})
